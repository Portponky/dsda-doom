...
state_t doom_states[DOOM_NUMSTATES] = {
  ...
  {SPR_MISG,1,8,A_GunFlashDelay,S_MISSILE2,0,0}, // S_MISSILE1
  ...
  {SPR_BAL1,32768,4,A_MissileFly,S_TBALL2,0,0}, // S_TBALL1
  ...
  {SPR_BAL2,32768,4,A_MissileFly,S_RBALL2,0,0}, // S_RBALL1
  ...
  {SPR_MISL,32768,1,A_MissileFly,S_ROCKET2,0,0}, // S_ROCKET
  {SPR_MISL,32768,1,NULL,S_ROCKET,0,0}, // S_ROCKET2
  ...
  {SPR_MANF,32768,4,A_MissileFly,S_FATSHOT2,0,0}, // S_FATSHOT1
  ...
  {SPR_BAL7,32768,4,A_MissileFly,S_BRBALL2,0,0},  // S_BRBALL1
  ...
  {SPR_APLS,32768,5,A_MissileFly,S_ARACH_PLAZ2,0,0},  // S_ARACH_PLAZ
